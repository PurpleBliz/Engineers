...
namespace Engineers.Migrations
{
    ...
    [Migration("20210824103005_usermess1")]
    partial class usermess1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Engineers.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Engineers.Models.Message", b =>
                {
                    b.HasOne("Engineers.Models.User", "Sander")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Engineers.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
